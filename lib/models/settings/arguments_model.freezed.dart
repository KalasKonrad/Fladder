...
mixin _$ArgumentsModel {
  ...
  @override
  String toString() {
    return 'ArgumentsModel(htpcMode: $htpcMode, leanBackMode: $leanBackMode, startFullscreen: $startFullscreen, newWindow: $newWindow, skipNotifications: $skipNotifications)';
  }
}
    ...
    return _then(_self.copyWith(
      ...
      leanBackMode: null == leanBackMode
          ...
          : leanBackMode // ignore: cast_nullable_to_non_nullable
              as bool,
      startFullscreen: null == startFullscreen
          ? _self.startFullscreen
          : startFullscreen // ignore: cast_nullable_to_non_nullable
              as bool,
...
extension ArgumentsModelPatterns on ArgumentsModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool htpcMode, bool leanBackMode, bool startFullscreen,
            bool newWindow, bool skipNotifications)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ArgumentsModel() when $default != null:
        return $default(_that.htpcMode, _that.leanBackMode,
            _that.startFullscreen, _that.newWindow, _that.skipNotifications);
      case _:
        return orElse();
    }
  }
